...
print(numbers)
higher_than_nine_numbers = [number for number in numbers if number > 9]
print(higher_than_nine_numbers)
longer_last_names = [name for name in full_names if len(name) > 11]
last_name = [name.split(" ") for name in full_names if name in longer_last_names]
last_name = [name[1] for name in last_name]
print(str(last_name).strip("[]"))
